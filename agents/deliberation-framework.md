# Council-Of-HALs Deliberation Framework for QA Agents

## Purpose
This framework provides comprehensive guidance on using the `mcp__council-of-hals__deliberate` tool for multi-model consensus in quality assurance decisions. QA agents reference this document to understand when, how, and why to invoke deliberative decision-making across multiple AI models.
...
4. Invoke mcp__council-of-hals__deliberate
