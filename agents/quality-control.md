...
tools: Read, Write, Grep, Glob, TodoWrite, Task, Bash(git*), Bash(python*), Bash(make*), Edit, MultiEdit, Bash, Bash(fd*), Bash(rg*), mcp__council-of-hals__deliberate
color: red
---
...
#### Using the mcp__council-of-hals__deliberate Tool
